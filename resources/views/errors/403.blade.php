    ...
    <main class="error-shell" aria-labelledby="error-title">
        <section class="error-card">
            <div class="error-copy">
                <span class="eyebrow"><i class="ri-lock-2-line" aria-hidden="true"></i> Acci&oacute;n restringida</span>
                <p class="error-code">403</p>
                <h1 id="error-title">Acceso denegado</h1>
                <p class="description">No tienes permiso para acceder a esta secci&oacute;n o la acci&oacute;n est&aacute; restringida para tu cuenta.</p>
            ...
            <div class="error-visual" aria-hidden="true"><i class="ri-lock-2-line"></i></div>
        </section>
        <p class="support-note">Si crees que necesitas acceso, contacta con el administrador del sistema.</p>
    </main>
