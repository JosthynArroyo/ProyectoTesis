    ...
    <main class="error-shell" aria-labelledby="error-title">
        <section class="error-card">
            <div class="error-copy">
                <span class="eyebrow"><i class="ri-compass-3-line" aria-hidden="true"></i> Ruta no disponible</span>
                <p class="error-code">404</p>
                <h1 id="error-title">P&aacute;gina no encontrada</h1>
                <p class="description">La p&aacute;gina que intentas acceder no existe, fue movida o ya no est&aacute; disponible.</p>
            ...
            <div class="error-visual" aria-hidden="true"><i class="ri-compass-3-line"></i></div>
        </section>
        <p class="support-note">Puedes continuar desde el inicio del sistema o volver a la pantalla anterior.</p>
    </main>
