...
<head>
    ...
    <title>419 | Sesi&oacute;n expirada</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hint i { flex: 0 0 auto; margin-top: .1rem; font-size: 1.1rem; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .hint { color: #bae6fd; background: rgba(2, 132, 199, .16); border-color: rgba(56, 189, 248, .28); }
    ...
    <main class="error-shell" aria-labelledby="error-title">
        <section class="error-card">
            <div class="error-copy">
                <span class="eyebrow"><i class="ri-time-line" aria-hidden="true"></i> Tiempo de sesi&oacute;n agotado</span>
                <p class="error-code">419</p>
                <h1 id="error-title">Sesi&oacute;n expirada</h1>
                <p class="description">Tu sesi&oacute;n o el formulario ya no son v&aacute;lidos. Esto puede ocurrir si la p&aacute;gina estuvo abierta por mucho tiempo.</p>
                <p class="hint"><i class="ri-refresh-line" aria-hidden="true"></i> Recarga la p&aacute;gina e intenta enviar el formulario nuevamente.</p>
            ...
            <div class="error-visual" aria-hidden="true"><i class="ri-time-line"></i></div>
        </section>
        <p class="support-note">Para formularios, vuelve a intentarlo desde una p&aacute;gina actualizada.</p>
    </main>
