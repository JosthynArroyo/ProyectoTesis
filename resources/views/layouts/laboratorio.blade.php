...
@php($headerTitle = trim($__env->yieldContent('header-title')) ?: 'Panel laboratorio')
@php($headerSubtitle = trim($__env->yieldContent('header-subtitle')) ?: 'Gestión de órdenes y resultados')
