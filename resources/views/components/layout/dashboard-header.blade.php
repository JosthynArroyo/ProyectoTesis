...
<header class="dashboard-topbar border-b border-slate-200/80 bg-white" data-dashboard-topbar>
        ...
        <div class="flex min-w-0 flex-wrap items-center justify-end gap-2 sm:gap-3">
            ...
            @if($user && $user->hasRole('administrador'))
                <div class="relative">
                    ...
                    <div id="admin-notifications-dropdown" class="z-50 hidden w-72 max-w-[calc(100vw-2rem)] rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
            ...
            <div id="user-dropdown" class="z-50 hidden w-56 max-w-[calc(100vw-2rem)] rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
                <div class="px-3 py-2">
                ...
                @endif
                <button type="button" class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-slate-600 hover:bg-slate-50" data-legal-open="privacy-policy-modal">
                    <i class="ri-shield-check-line"></i> Políticas de privacidad
                </button>
                <button type="button" class="flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-slate-600 hover:bg-slate-50" data-legal-open="terms-service-modal">
