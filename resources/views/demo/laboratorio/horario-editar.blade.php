...
@section('title','Editar horario | Laboratorio - Demo')
...
@section('main')
  <div class="space-y-6">
    <div class="card p-6 bg-white">
      ...
      <form method="POST" action="{{ route('demo.laboratorio.horario.update', $horario->id) }}" class="mt-4 grid gap-4 md:grid-cols-2">
        @csrf
        @method('PUT')
        ...
        <div class="md:col-span-2">
          <x-ui.form-actions>
            <x-slot:left>
              <a class="btn btn-ghost" href="{{ route('demo.laboratorio.horario.index') }}">Volver</a>
            </x-slot>
