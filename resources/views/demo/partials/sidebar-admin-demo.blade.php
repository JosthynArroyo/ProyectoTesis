<aside class="dashboard-sidebar fixed top-0 bottom-0 left-0 z-40 h-screen -translate-x-full overflow-y-auto border-r border-gray-200/70 bg-white px-4 pb-6 pt-0 shadow-xl lg:translate-x-0 lg:shrink-0">
    ...
    <nav class="mt-7 flex flex-col gap-1.5 text-[0.95rem] font-semibold leading-6">
        ...
        <a href="{{ route('demo.admin.historial-clinico') }}" class="flex min-h-[44px] items-center gap-3 rounded-xl px-3 py-2.5 transition-colors {{ request()->routeIs('demo.admin.historial-clinico') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' }}">
        ...
        <a href="{{ route('demo.admin.usuarios') }}" class="flex min-h-[44px] items-center gap-3 rounded-xl px-3 py-2.5 transition-colors {{ request()->routeIs('demo.admin.usuarios') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' }}">
            <i class="ri-group-line text-lg"></i> Usuarios
        </a>
        <a href="{{ route('demo.admin.registrar-usuario') }}" class="flex min-h-[44px] items-center gap-3 rounded-xl px-3 py-2.5 transition-colors {{ request()->routeIs('demo.admin.registrar-usuario') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' }}">
        ...
        <details class="group rounded-xl {{ request()->routeIs('demo.admin.personalizacion') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' }}" {{ request()->routeIs('demo.admin.personalizacion') ? 'open' : '' }}>
            ...
            <div class="mb-2 flex flex-col gap-1 pl-11 pr-3">
                <a href="{{ route('demo.admin.personalizacion') }}#bienvenida" class="panel-subaction-button">Bienvenida</a>
                <a href="{{ route('demo.admin.personalizacion') }}#servicios" class="panel-subaction-button">Servicios</a>
                <a href="{{ route('demo.admin.personalizacion') }}#contacto" class="panel-subaction-button">Contacto</a>
            </div>
        </details>
