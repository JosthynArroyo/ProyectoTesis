  ...
  <section class="card p-6">
    <div class="flex flex-wrap items-center justify-between gap-4">
      <div>
        ...
        <h1 class="mt-2 text-2xl font-semibold text-slate-900">Editar contenido pÃºblico</h1>
        <p class="text-slate-600">Los cambios se reflejan automÃ¡ticamente en el sitio.</p>
      </div>
    </div>
  </section>
