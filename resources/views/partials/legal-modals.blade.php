@once
@php
  $legalBrandName = $clinicIdentity->name();
  $legalAddress = $clinicIdentity->address() ?? 'direccion institucional no configurada';
  $legalPhone = $clinicIdentity->phone() ?? 'telefono institucional no configurado';
  ...
  $privacyTitle = $siteSettings->get('legal.privacy_title', 'Tratamiento de datos personales y de salud');
  $privacyUpdatedAt = $siteSettings->get('legal.privacy_updated_at', 'Última actualización: abril de 2026');
  $privacyBody = trim((string) $siteSettings->get('legal.privacy_body', ''));
  $termsTitle = $siteSettings->get('legal.terms_title', 'Condiciones de uso de la plataforma');
  $termsUpdatedAt = $siteSettings->get('legal.terms_updated_at', 'Última actualización: abril de 2026');
  $termsBody = trim((string) $siteSettings->get('legal.terms_body', ''));
@endphp
...
<div id="privacy-policy-modal" class="modal" role="dialog" aria-modal="true" aria-labelledby="privacy-policy-title" aria-describedby="privacy-policy-summary" aria-hidden="true" data-legal-modal>
  ...
  <div class="modal-dialog" role="document" tabindex="-1">
    <article class="card mx-auto flex w-full max-w-4xl flex-col !overflow-hidden">
      <header class="flex items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:px-6">
        <div class="min-w-0">
          <p class="text-xs font-semibold uppercase tracking-widest text-teal-700">Políticas de privacidad</p>
          <h2 id="privacy-policy-title" class="mt-1 text-xl font-semibold text-gray-900">{{ $privacyTitle }}</h2>
          <p id="privacy-policy-summary" class="mt-1 text-sm text-gray-500">{{ $privacyUpdatedAt }}</p>
        </div>
      ...
      <div class="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-8">
        @if($privacyBody !== '')
          <div class="whitespace-pre-line text-sm leading-7 text-gray-600">{{ $privacyBody }}</div>
        @else
        <div class="space-y-5 text-sm leading-7 text-gray-600">
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">1. Responsable del tratamiento</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">2. Datos que tratamos</h3>
            ...
            <p>Además, se registran datos técnicos y de seguridad, como dirección IP, navegador, dispositivo, actividad de sesión, eventos de acceso, archivos cargados y registros necesarios para proteger la plataforma.</p>
          </section>

          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">3. Finalidad del uso de datos</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">4. Base legal</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">5. Cookies y comunicaciones</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">6. Proveedores y comunicación de datos</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">7. Seguridad y confidencialidad</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">8. Conservación</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">9. Derechos del titular</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">10. Menores de edad y actualizaciones</h3>
      ...
      <footer class="flex flex-wrap items-center justify-end gap-2 border-t border-gray-100 px-5 py-4 sm:px-6">
    ...
    <article class="card mx-auto flex w-full max-w-4xl flex-col !overflow-hidden">
      <header class="flex items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:px-6">
        <div class="min-w-0">
          ...
          <h2 id="terms-service-title" class="mt-1 text-xl font-semibold text-gray-900">{{ $termsTitle }}</h2>
          <p id="terms-service-summary" class="mt-1 text-sm text-gray-500">{{ $termsUpdatedAt }}</p>
        </div>
      ...
      <div class="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-8">
        @if($termsBody !== '')
          <div class="whitespace-pre-line text-sm leading-7 text-gray-600">{{ $termsBody }}</div>
        @else
        <div class="space-y-5 text-sm leading-7 text-gray-600">
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">1. Objeto del servicio</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">2. Acceso y veracidad de la información</h3>
            <p>El acceso requiere una cuenta válida y credenciales personales. El usuario debe proporcionar información verdadera, completa y actualizada, especialmente datos de identificación, contacto, salud, citas y pagos.</p>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">3. Uso según el tipo de cuenta</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">4. Alcance médico del sistema</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">5. Citas, reprogramaciones e inasistencias</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">6. Pagos y documentos</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">7. Información médica y laboratorio</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">8. Responsabilidades del usuario</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">9. Disponibilidad y limitación de responsabilidad</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">10. Suspensión de cuentas</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">11. Propiedad intelectual y confidencialidad</h3>
          ...
          <section class="space-y-2">
            <h3 class="text-base font-semibold text-gray-900">12. Legislación aplicable y cambios</h3>
