...
<div class="welcome-cms-editor space-y-6" data-bienvenida-form data-asset-base="{{ $assetBase }}" data-storage-base="{{ $storageBase }}" data-current-year="{{ now()->year }}" data-initial-tab="{{ $activeTab }}">
  <section class="card overflow-hidden border border-gray-200/80 bg-white/95">
    <div class="border-b border-gray-200/80 bg-gradient-to-r from-gray-50 via-white to-gray-100/40 px-6 py-5">
      <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div class="space-y-2">
          <div class="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-gray-700">
            <i class="ri-dashboard-line"></i>
            Personalización de Bienvenida
          </div>
          <div>
            <h2 class="text-2xl font-semibold text-gray-900">Editor CMS para la página de inicio</h2>
            <p class="text-sm text-gray-500">Organiza identidad, navegación, hero, servicios, equipo, footer y estilo visual sin tocar la vista pública.</p>
          </div>
        </div>
        <div class="grid gap-2 text-sm text-gray-500 sm:grid-cols-3">
          <div class="rounded-2xl border border-gray-200 bg-white px-4 py-3">
            <p class="text-xs uppercase tracking-[0.18em] text-gray-400">Modo</p>
            <p class="mt-1 font-medium text-gray-700">CMS escalable</p>
          </div>
          <div class="rounded-2xl border border-gray-200 bg-white px-4 py-3">
            <p class="text-xs uppercase tracking-[0.18em] text-gray-400">Guardado</p>
            <p class="mt-1 font-medium text-gray-700">Compatible con admin/superadmin</p>
          </div>
          <div class="rounded-2xl border border-gray-200 bg-white px-4 py-3">
            <p class="text-xs uppercase tracking-[0.18em] text-gray-400">Vista</p>
            <p class="mt-1 font-medium text-gray-700">Vista previa en vivo</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="overflow-x-auto px-4 py-4">
      <div class="flex min-w-max gap-2" role="tablist" aria-label="Secciones de personalización de bienvenida">
        @foreach($tabDefinitions as $tab)
          <button
            type="button"
            class="welcome-cms-tab inline-flex items-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-600 transition {{ $loop->first ? 'is-active' : '' }}"
  ...
  <section class="card border border-gray-200/80 bg-white/95 px-6 py-5">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      <div>
        <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Acciones</p>
        <h3 class="mt-1 text-lg font-semibold text-gray-900">Gestiona la bienvenida y revisa la vista previa reactiva</h3>
        <p class="mt-1 text-sm text-gray-500">La vista previa se abre en un modal grande y muestra tus cambios sin guardar, sin cargar la página real.</p>
      </div>
      <div class="flex flex-wrap items-center gap-3">
        <button type="button" class="welcome-cms-action-button btn btn-outline" data-preview-open>
  ...
  <div class="space-y-6">
      <section id="welcome-tab-identidad" data-tab-panel="identidad" class="welcome-cms-panel space-y-5" role="tabpanel">
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Identidad</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Logo principal, favicon y naming institucional</h3>
              <p class="mt-1 text-sm text-gray-500">Desde aquí se gestiona el branding visible del header, del favicon y del contenido institucional.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            <div class="grid gap-5 lg:grid-cols-3">
              <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4">
                <p class="text-sm font-semibold text-gray-900">Logo principal del header</p>
                <div class="mt-4 flex h-36 items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white">
              ...
              <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4">
                <p class="text-sm font-semibold text-gray-900">Favicon</p>
                <div class="mt-4 flex h-36 items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white">
                  <div data-form-preview-favicon-wrap>
                    ...
                    @else
                      <div class="flex h-14 w-14 items-center justify-center rounded-2xl border border-gray-200 bg-gray-50 text-gray-400">
      ...
      <section id="welcome-tab-header" data-tab-panel="header" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Header</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Navegación principal</h3>
              <p class="mt-1 text-sm text-gray-500">Controla visibilidad, orden y comportamiento del navbar público.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            <div class="grid gap-4 lg:grid-cols-2">
              <label class="inline-flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50/80 px-4 py-4 text-sm text-gray-600">
                ...
                <span><span class="block font-medium text-gray-900">Mostrar Inicio</span><span class="block text-xs text-gray-500">Mantiene el acceso a la landing desde el header.</span></span>
              </label>
              <label class="inline-flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50/80 px-4 py-4 text-sm text-gray-600">
                ...
                <span><span class="block font-medium text-gray-900">Mostrar Servicios</span><span class="block text-xs text-gray-500">Expone el catálogo público de especialidades.</span></span>
              </label>
              <label class="inline-flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50/80 px-4 py-4 text-sm text-gray-600">
                ...
                <span><span class="block font-medium text-gray-900">Mostrar Contacto</span><span class="block text-xs text-gray-500">Permite acceso directo a la página de contacto.</span></span>
              </label>
              <label class="inline-flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50/80 px-4 py-4 text-sm text-gray-600">
                ...
                <span><span class="block font-medium text-gray-900">Header fijo</span><span class="block text-xs text-gray-500">Mantiene el header visible al hacer scroll.</span></span>
              </label>
            </div>
            <div class="mt-6 grid gap-4 lg:grid-cols-2">
              <div>
                ...
                <p class="mt-2 text-xs text-gray-500">Máximo 25 caracteres.</p>
              </div>
            </div>
            <div class="mt-6">
              <p class="text-sm font-semibold text-gray-900">Orden de navegación</p>
              ...
              <p class="mt-2 text-xs text-gray-500">Cada opción solo puede aparecer una vez.</p>
            </div>
          </div>
        </details>
      </section>
      ...
      <section id="welcome-tab-hero" data-tab-panel="hero" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Hero / Bienvenida</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Contenido principal y llamadas a la acción</h3>
              <p class="mt-1 text-sm text-gray-500">Edita el contenido visible del hero real: badge, título, subtítulo, botones y carrusel.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
        ...
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Carrusel</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Imágenes reales del hero</h3>
              <p class="mt-1 text-sm text-gray-500">Administra solo los elementos que hoy existen en la vista pública: imagen, texto alternativo, orden y visibilidad.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            <div class="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p class="text-sm font-semibold text-gray-900">Slides del hero</p>
                <p class="text-xs text-gray-500">Activa, ordena y reemplaza imágenes del carrusel.</p>
              </div>
              <button type="button" class="btn btn-outline" data-add-slide><i class="ri-add-line"></i> Agregar slide</button>
            </div>
            <div class="mt-4 grid gap-4" data-slide-list data-next-index="{{ count($slidesInput) }}">
              @foreach($slidesInput as $index => $slide)
                ...
                <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-slide-row data-row-key="slide-{{ $index }}">
                  <div class="grid gap-6">
                    <div class="flex flex-col sm:flex-row items-start gap-5 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                      ...
                      <div class="flex-1 w-full flex flex-col justify-center min-h-[10rem]">
                        <label class="form-label font-semibold text-gray-800">Imagen del slide</label>
                        <p class="mb-3 text-xs text-gray-500">Selecciona una imagen horizontal de alta calidad. Formatos recomendados: JPG, WEBP, PNG.</p>
                  ...
                  <button type="button" class="btn btn-ghost mt-4" data-remove-item>Quitar</button>
                </div>
              @endforeach
            </div>
          </div>
      ...
      <section id="welcome-tab-funcionalidades" data-tab-panel="funcionalidades" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Funcionalidades</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Mini cards visibles del hero</h3>
              <p class="mt-1 text-sm text-gray-500">Solo se editan las dos cards que hoy aparecen debajo del subtítulo del hero.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            <div class="grid gap-4 lg:grid-cols-2">
              <div class="rounded-3xl border border-gray-200 bg-gray-50/80 p-4">
                <p class="text-sm font-semibold text-gray-900">Mini card 1</p>
              ...
              <div class="rounded-3xl border border-gray-200 bg-gray-50/80 p-4">
                <p class="text-sm font-semibold text-gray-900">Mini card 2</p>
                <div class="mt-4 space-y-4">
      ...
      <section id="welcome-tab-servicios" data-tab-panel="servicios" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Servicios</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Bloque de especialidades destacadas</h3>
              <p class="mt-1 text-sm text-gray-500">Define textos, CTA, especialidades exactas y la descripción breve visible debajo de cada una.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-3">
              @for($i = 0; $i < 3; $i++)
                <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-featured-specialty-slot>
                  ...
                  <div class="mt-4">
                    ...
                    <p class="mt-2 text-xs text-gray-500">Se guardará en la especialidad seleccionada y se mostrará en Welcome.</p>
                  </div>
                </div>
              @endfor
            </div>
            <p class="mt-2 text-xs text-gray-500">Una especialidad no puede repetirse en más de una posición.</p>
          </div>
        </details>
      </section>
      ...
      <section id="welcome-tab-valores" data-tab-panel="valores" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Valores referenciales</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Tarifario, tarjeta informativa y agenda paso a paso</h3>
              <p class="mt-1 text-sm text-gray-500">Organiza el bloque actual de valores sin imágenes laterales obsoletas.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            ...
            <div class="mt-6 flex flex-wrap items-center justify-between gap-3">
              <div>
                <p class="text-sm font-semibold text-gray-900">Lista de precios</p>
                <p class="text-xs text-gray-500">Puedes usar valores o el texto Consultar.</p>
              </div>
              <button type="button" class="btn btn-outline" data-add-price><i class="ri-add-line"></i> Agregar fila</button>
            </div>
            <div class="mt-4 grid gap-4" data-price-list data-next-index="{{ count($pricesInput) }}">
              @foreach($pricesInput as $index => $price)
                <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-price-row data-row-key="price-{{ $index }}">
                  <div class="grid gap-4 lg:grid-cols-2">
      ...
      <section id="welcome-tab-equipo" data-tab-panel="equipo" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Equipo médico</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Directorio visual de doctores</h3>
              <p class="mt-1 text-sm text-gray-500">Incluye nombre, especialidad real, experiencia, badges y estados visibles en el home.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            ...
            <div class="mt-6 flex flex-wrap items-center justify-between gap-3">
              <div>
                <p class="text-sm font-semibold text-gray-900">Lista de doctores</p>
                <p class="text-xs text-gray-500">Usa especialidades reales del sistema y evita textos desalineados con la landing actual.</p>
              </div>
              <button type="button" class="btn btn-outline" data-add-doctor><i class="ri-add-line"></i> Agregar doctor</button>
            </div>
            <div class="mt-3 rounded-2xl border border-gray-200 bg-gray-50/80 px-4 py-3 text-sm text-gray-600" data-doctor-active-summary>
              Máximo 3 doctores pueden estar marcados como visibles en la landing pública.
            </div>
            @error('doctors')
              <div class="mt-3 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">{{ $message }}</div>
            @enderror
            <div class="mt-4 grid gap-4" data-doctor-list data-next-index="{{ count($doctorsInput) }}">
              @foreach($doctorsInput as $index => $doctor)
                ...
                <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-doctor-row data-row-key="doctor-{{ $index }}">
                  <div class="grid gap-4 xl:grid-cols-[176px_minmax(0,1fr)]">
                    ...
                    <div class="grid gap-4 lg:grid-cols-2">
                      ...
                      <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Máximo 60 caracteres.</p>
                      </div>
      ...
      <section id="welcome-tab-footer" data-tab-panel="footer" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Footer</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Texto legal, enlaces, contacto y legales</h3>
              <p class="mt-1 text-sm text-gray-500">La vista pública sigue usando los mismos partials, ahora alimentados desde este panel.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
            ...
            <div class="mt-6">
              <p class="text-sm font-semibold text-gray-900">Enlaces visibles</p>
      ...
      <section id="welcome-tab-visual" data-tab-panel="visual" class="welcome-cms-panel space-y-5" role="tabpanel" hidden>
        <details open class="card overflow-hidden border border-gray-200/80 bg-white/95">
          <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5">
            <div>
              <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Estilo visual</p>
              <h3 class="mt-1 text-lg font-semibold text-gray-900">Fondos suaves y gradientes secundarios</h3>
              <p class="mt-1 text-sm text-gray-500">Solo se permiten tonos suaves decorativos. El blanco base del sistema no se modifica.</p>
            </div>
            <i class="ri-arrow-down-s-line text-xl text-gray-400"></i>
          </summary>
          <div class="border-t border-gray-200/80 px-6 py-6">
              ...
              @foreach([
                ...
                <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4">
                  ...
                  <div class="mt-3 flex items-center gap-3">
                    ...
                    <div class="min-w-0">
                      <p class="text-xs uppercase tracking-[0.18em] text-gray-400">Color actual</p>
                      <p class="text-sm font-semibold text-gray-700" data-color-value-for="{{ $colorField['name'] }}">{{ $colorField['value'] }}</p>
                    </div>
                  </div>
            ...
            <div class="mt-6 rounded-3xl border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-amber-800">Los tres primeros colores actualizan los tokens reales de Welcome. Los cinco tonos inferiores controlan fondos suaves, badges y gradientes decorativos de la landing.</div>
          </div>
        </details>
      </section>
  ...
  <div class="welcome-cms-preview-modal" data-preview-modal hidden>
    ...
    <section class="welcome-cms-preview-dialog" role="dialog" aria-modal="true" aria-labelledby="welcomePreviewTitle">
      <div class="border-b border-gray-200/80 px-5 py-5 sm:px-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Vista previa reactiva</p>
            <h3 id="welcomePreviewTitle" class="mt-1 text-lg font-semibold text-gray-900">Vista previa de bienvenida</h3>
            <p class="mt-1 text-sm text-gray-500">Modal de vista previa visual. No usa iframe, no usa navegación real y refleja cambios sin guardar.</p>
          </div>
          <div class="flex flex-wrap items-center gap-3">
            <div class="rounded-2xl border border-gray-200 bg-gray-50 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">
              Vista de escritorio
            </div>
            <button type="button" class="welcome-cms-action-button btn btn-ghost" data-preview-close>
  ...
  <template data-slide-template>
    <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-slide-row data-row-key="slide-__INDEX__">
      <div class="grid gap-6">
        <div class="flex flex-col sm:flex-row items-start gap-5 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
          <div class="w-full sm:w-[240px] shrink-0">
            <div class="welcome-cms-media-frame welcome-cms-media-frame--slide" data-inline-image-preview data-preview-icon="ri-image-line" data-preview-placeholder="Vista previa del slide">
  ...
  <template data-price-template>
    <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-price-row data-row-key="price-__INDEX__">
      <div class="grid gap-4 lg:grid-cols-2">
  ...
  <template data-doctor-template>
    <div class="rounded-3xl border border-gray-200 bg-gray-50/70 p-4" data-doctor-row data-row-key="doctor-__INDEX__">
      <div class="grid gap-4 xl:grid-cols-[176px_minmax(0,1fr)]">
        <div class="welcome-cms-media-frame welcome-cms-media-frame--doctor" data-inline-image-preview data-preview-icon="ri-user-3-line" data-preview-placeholder="Vista previa del doctor">
          <div class="welcome-cms-media-placeholder">
            <i class="ri-user-3-line"></i>
