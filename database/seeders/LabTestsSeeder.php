    ...
    public function run(): void
    {
        $tests = [
            ...
            [
                ...
                'indicaciones_default' => 'No realizar actividad fisica intensa antes de la toma.',
                'ayuno_horas' => 8,
            ...
            [
                ...
                'indicaciones_default' => 'Recolecta muestra de mitad de la miccion en frasco esteril.',
                'ayuno_horas' => null,
                'restricciones' => 'Evitar diureticos si tu doctor no lo indico.',
                'duracion_minutos' => 5,
            ],
            [
                ...
                'requiere_orden' => false,
                'es_rutina' => true,
                'preparacion_default' => 'Ayuno: No requiere ayuno. Agua: Agua permitida. Horario recomendado: Entregar muestra el mismo dia.',
            ...
            [
                ...
                'indicaciones_default' => 'Informar si toma diureticos o antibioticos.',
                'ayuno_horas' => 8,
